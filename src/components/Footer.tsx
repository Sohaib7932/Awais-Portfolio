    ...
    >
      ...
      <div className="flex items-center gap-12">
        ...
        <a
          ...
          className="flex items-center gap-2 rounded-lg border border-primary/30 bg-primary/10 px-6 py-3 font-tech text-label uppercase text-primary transition-all hover:bg-primary/20"
        >
